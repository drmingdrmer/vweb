...
class SaeTClient
{
    ...
    function public_timeline( $count = 20, $base_app = 0 )
    {
        ...
        return $this->oauth->get('http://api.weibo.com/2/statuses/public_timeline.json', $params);
    }
    ...
    function home_timeline( $page = 1, $count = 20, $since_id = NULL, $max_id = NULL, $base_app = 0, $feature = 0 )
    {
        ...
        return $this->request_with_pager('http://api.weibo.com/2/statuses/home_timeline.json', $page, $count, $params );
    }
    ...
    function mentions( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/statuses/mentions.json' , $page , $count, $params );
    }
    ...
    {
        //  http://api.weibo.com/2/statuses/update.json
        $params = array();
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/update.json' , $params );
    }
    ...
    function upload( $status , $pic_path, $lat = NULL, $long = NULL )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/upload.json' , $params , true );
    }
    ...
    {
        $this->id_format($sid);
        return $this->oauth->get( 'http://api.weibo.com/2/statuses/show/' . $sid . '.json' );
    }
    ...
    {
        $this->id_format($sid);
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/destroy/' . $sid . '.json' );
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/users/show.json' ,  $uid_or_name );
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/statuses/friends.json' ,  $uid_or_name , NULL , $count , $cursor );
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/statuses/followers.json' ,  $uid_or_name , NULL , $count , $cursor );
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/friendships/create.json' ,  $uid_or_name ,  NULL , NULL , NULL , true  );
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/friendships/destroy.json' ,  $uid_or_name ,  NULL , NULL , NULL , true);
    }
    ...
    function get_status_url( $sid, $uid = NULL )
    {
        ...
        return "http://api.weibo.com/2/$uid/statuses/$sid";
    }
    ...
    function update_remark( $uid, $remark )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/user/friends/update_remark.json' , $params );
    }
    ...
    function hot_users( $category = "default" )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/users/hot.json' , $params );
    }
    ...
    function emotions( $type = "face", $language = "cnname" )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/emotions.json' , $params );
    }
    ...
    function reset_count( $type )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/statuses/reset_count.json' , $params );
    }
    ...
    function is_followed( $target, $source = NULL )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/friendships/show.json' , $params );
    }
    ...
    function user_timeline( $page = 1 , $count = 20 , $uid_or_name = NULL , $since_id = NULL, $max_id = NULL)
    {
        ...
        return $this->request_with_uid( 'http://api.weibo.com/2/statuses/user_timeline.json' ,  $uid_or_name , $page , $count , NULL , true, $params );
    }
    ...
    function list_dm( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/direct_messages.json' , $page , $count, $params );
    }
    ...
    function list_dm_sent( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/direct_messages/sent.json' , $page , $count, $params );
    }
    ...
    function send_dm( $uid_or_name , $text )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/direct_messages/new.json' , $params  );
    }
    ...
    {
        $this->id_format($did);
        return $this->oauth->post( 'http://api.weibo.com/2/direct_messages/destroy/' . $did . '.json' );
    }
    ...
    function delete_dms( $dids )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/direct_messages/destroy_batch.json' , $params );
    }
    ...
    function repost_by_me( $uid, $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/statuses/repost_by_me.json' , $page , $count , $params );
    }
    ...
    function repost_timeline( $sid, $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/statuses/repost_timeline.json' , $page , $count , $params );
    }
    ...
    function repost( $sid , $text = NULL, $is_comment = 0 )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/repost.json' , $params  );
    }
    ...
    function send_comment( $sid , $text , $cid = NULL )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/comment.json' , $params  );
    ...
    function comment_destroy_batch( $cids )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/comment/destroy_batch.json' , $params );
    }
    ...
    function unread( $with_new_status = 0, $since_id = NULL )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/statuses/unread.json' , $params );
    }
    ...
    function reply( $sid , $text , $cid )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/reply.json' , $params  );
    ...
    function get_favorites( $page = NULL )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/favorites.json', $params );
    }
    ...
    {
        $this->id_format($cid);
        return $this->oauth->post( 'http://api.weibo.com/2/statuses/comment_destroy/' . $cid . '.json' );
    }
    ...
    function comments_to_me( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/statuses/comments_to_me.json' , $page , $count , $params );
    }
    ...
    function comments_by_me( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/statuses/comments_by_me.json' , $page , $count , $params );
    }
    ...
    function comments_timeline( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/statuses/comments_timeline.json' , $page , $count , $params );
    }
    ...
    function get_comments_by_sid( $sid , $page = 1 , $count = 20 )
    {
        ...
        return $this->oauth->get('http://api.weibo.com/2/statuses/comments.json' , $params );
    ...
    function get_count_info_by_ids( $sids )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/statuses/counts.json' , $params );
    }
    ...
    function add_to_favorites( $sid )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/favorites/create.json' , $params );
    }
    ...
    function remove_from_favorites_batch( $fids )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/favorites/destroy_batch.json' , $params );
    }
    ...
    {
        $this->id_format($id);
        return $this->oauth->post( 'http://api.weibo.com/2/favorites/destroy/' . $id . '.json'  );
    }
    ...
    {
        return $this->oauth->get('http://api.weibo.com/2/account/verify_credentials.json');
    }
    ...
    {
        return $this->oauth->get('http://api.weibo.com/2/account/rate_limit_status.json');
    }
    ...
    {
        return $this->oauth->post('http://api.weibo.com/2/account/end_session.json');
    }
    ...
    {
        return $this->oauth->post('http://api.weibo.com/2/account/update_privacy.json', $privacy_settings);
    }
    ...
    {
        return $this->oauth->post('http://api.weibo.com/2/account/get_privacy.json');
    }
    ...
    function update_profile_image($image_path)
    {
        ...
        return $this->oauth->post('http://api.weibo.com/2/account/update_profile_image.json', $params, true);
    }
    ...
    {
        return $this->oauth->post('http://api.weibo.com/2/account/update_profile.json', $profile);
    }
    ...
    function provinces()
    {
        return $this->oauth->get('http://api.weibo.com/2/provinces.json');
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/friends/ids.json' ,  $uid_or_name , false , $count , $cursor );
    }
    ...
    {
        return $this->request_with_uid( 'http://api.weibo.com/2/followers/ids.json' ,  $uid_or_name , false , $count , $cursor );
    }
    ...
    function add_to_blocks( $user_id = NULL, $screen_name = NULL )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/blocks/create.json' , $params );
    }
    ...
    function remove_from_blocks( $user_id = NULL, $screen_name = NULL )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/blocks/destroy.json' , $params );
    }
    ...
    function in_blocks( $user_id = NULL, $screen_name = NULL )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/blocks/exists.json' , $params );
    }
    ...
    {
        return $this->request_with_pager( 'http://api.weibo.com/2/blocks/blocking.json' , $page , $count );
    }
    ...
    {
        return $this->request_with_pager( 'http://api.weibo.com/2/blocks/blocking/ids.json' , $page , $count );
    }
    ...
    function get_tags( $user_id = NULL, $page = 1, $count = 20 )
    {
        ...
        return $this->request_with_pager( 'http://api.weibo.com/2/tags.json' , $page , $count , $params );
    }
    ...
    function add_tags( $tags )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/tags/create.json' , $params );
    }
    ...
    {
        return $this->request_with_pager( 'http://api.weibo.com/2/tags/suggestions.json' , $page , $count );
    }
    ...
    function delete_tag( $tag_id )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/tags/destroy.json' , $params );
    }
    ...
    function delete_tags( $ids )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/tags/destroy_batch.json' , $params );
    }
    ...
    function get_trends( $user_id = NULL, $page = 1, $count = 20 )
    {
        ...
        $this->id_format($params['user_id']);
        return $this->request_with_pager( 'http://api.weibo.com/2/trends.json' , $page , $count , $params );
    }
    ...
    function trends_timeline( $trend_name )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/trends/statuses.json' , $params );
    }
    ...
    function follow_trends( $trend_name )
    {
        ...
        return $this->oauth->post( 'http://api.weibo.com/2/trends/follow.json' , $params );
    }
    ...
    function unfollow_trends( $tid )
    {
        ...
        return $this->oauth->delete( 'http://api.weibo.com/2/trends/destroy.json' , $params );
    }
    ...
    function hourly_trends( $base_app = 1 )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/trends/hourly.json' , $params );
    }
    ...
    function daily_trends( $base_app = 1 )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/trends/daily.json' , $params );
    }
    ...
    function weekly_trends( $base_app = 1 )
    {
        ...
        return $this->oauth->get( 'http://api.weibo.com/2/trends/weekly.json' , $params );
    }
...
class SaeTOAuth {
     ...
     * @ignore
     */
    public $host = "http://api.weibo.com/2/";
    /**
     * Set timeout default.
     *
     * @ignore
     ...
     * @ignore
     */
    function accessTokenURL()  { return 'http://api.weibo.com/oauth2/access_token'; }
    /**
     * @ignore
     */
    function authenticateURL() { return 'http://api.weibo.com/oauth2/authenticate'; }
    /**
     * @ignore
     */
    function authorizeURL()    { return 'http://api.weibo.com/oauth2/authorize'; }
    /**
     * @ignore
     */
    function requestTokenURL() { return 'http://api.weibo.com/oauth2/request_token'; }
